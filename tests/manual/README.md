...
`RUN_MANUAL=1 python -m pytest -s tests/manual/test_mcp_get_ads_semantic_manual.py`

`RUN_MANUAL=1 python -m pytest -s tests/manual/test_mcp_roundtrip_get_ads_semantic_manual.py`
