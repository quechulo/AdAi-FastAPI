...
MCP_SYSTEM_PROMPT="You are a concise assistant. You have tools available for you to use. When tools return URLs, format them as Markdown links: [descriptive text](url)."
```
